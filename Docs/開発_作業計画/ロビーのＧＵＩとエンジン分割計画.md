...
ロールバック：PlayRoomEngineJsonLinesHost、PlaySpace.Conformance、Samples/External.PlaySpace.Counter、Conformance/ProtocolS/v1、SDK文書、公式ホストProgramのSDK化、ソリューション・発行スクリプトの第10段階追加を除く。第9段階のクライアント・マニフェスト境界は維持できる

...
> 現状と後続作業は [Player・Client Identityの実装状況](../CurrentState/PlayerProfiles.md) / [プロフィールの将来の用語整理](../Plans/ProfileTerminology.md) / [Player統合の後続課題](../Plans/PlayerProfiles.md) を参照してください。
...
この節は[内容別の文書](../CurrentState/PlayerProfiles.md)へ移しました。

### 残作業

この節に混在していた完了項目は[実装状況](../CurrentState/PlayerProfiles.md)、未着手案は[後続計画](../Plans/PlayerProfiles.md)へ分離しました。
...
この節は[内容別の文書](../Plans/PlayerProfiles.md)へ移しました。

## 将来の用語整理案（本計画の完了後）

この節は[内容別の文書](../Plans/ProfileTerminology.md)へ移しました。

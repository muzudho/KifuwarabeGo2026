...
> [!IMPORTANT]
> 通常利用者は `KifuwarabeGo2026.Launcher-v3.15.0-win-x64.zip` をダウンロードしてください。`.zip.sha256` はランチャーが自動検証に使う機械向けファイルで、利用者がダウンロードする必要はありません。GUI版・Engine版ZIPは単独利用・互換運用向けです。
...
- `KifuwarabeGo2026.GameOasis.Gui-v3.15.0-win-x64.zip`

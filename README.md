...
［きふわらべの碁２０２６］ は、C# / MonoGame をベースに AIコーディングしたコンピューター囲碁アプリケーションです。  
9路、13路、19路の対局画面を持ち、別プロセスの GTP エンジンと接続して人間対コンピューター、コンピューター同士の対局を動かせます。  

![スクリーンショットv2.2.0](./RepositoryAssets/Screenshots/kifuwarabeGo2026-dev-20260726-0131-v220-playing.png)  
（画面は開発中のものです。 v2.2.0）  

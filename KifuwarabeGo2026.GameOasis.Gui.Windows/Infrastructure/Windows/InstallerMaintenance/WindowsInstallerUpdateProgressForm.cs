...
internal sealed class WindowsInstallerUpdateProgressForm : Form
{
    private readonly WindowsInstallerPackageInstaller installer;
    private readonly Label statusLabel = new();

    public WindowsInstallerUpdateProgressForm(WindowsInstallerPackageInstaller installer)
    {
        this.installer = installer;
        Text = "インストーラーを更新しています";
    ...
    public InstallerInstallResult? Result { get; private set; }

...
public sealed record PlaySpaceHostManifest(
    int Version,
...
{
    public static PlaySpaceHostManifest Load(string manifestPath)
    {
        var manifest = JsonSerializer.Deserialize<PlaySpaceHostManifest>(
            File.ReadAllText(manifestPath), PlaySpaceJsonLinesProtocol.JsonOptions)

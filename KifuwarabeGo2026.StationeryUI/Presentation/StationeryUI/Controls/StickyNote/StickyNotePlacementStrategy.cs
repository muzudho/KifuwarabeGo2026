namespace KifuwarabeGo2026.GameOasis.Gui.Presentation.StationeryUI.Controls.StickyNote;
...
public static class StickyNotePlacementStrategies
{
    private static readonly IReadOnlyDictionary<(StickyNoteScreenId Screen, StickyNoteKind Kind), IStickyNotePlacementStrategy> Strategies =
        new Dictionary<(StickyNoteScreenId, StickyNoteKind), IStickyNotePlacementStrategy>
        {
            ...
            [(StickyNoteScreenId.TitleHome, StickyNoteKind.TitleUpdateHint)] = Fixed(new Rectangle(1412, 760, 400, 160), bounds => new Vector2(bounds.Left, bounds.Center.Y)),
            ...
            [(StickyNoteScreenId.CgosConnection, StickyNoteKind.CgosEngineCommandHint)] = Fixed(new Rectangle(1650, 390, 240, 210), bounds => new Vector2(bounds.Left, bounds.Center.Y)),

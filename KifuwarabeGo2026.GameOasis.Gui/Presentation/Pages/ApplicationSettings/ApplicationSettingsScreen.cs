...
public sealed class ApplicationSettingsScreen
{
    ...
    private ApplicationSettingsScreen()
    {
        ...
        UpdateButton = new Button(new Rectangle(1316, 972, 220, 62), "インストーラーを更新", 0.22f);
        OpenInstallerButton = new Button(new Rectangle(1548, 972, 220, 62), "インストーラーを起動", 0.22f);
    ...
    public Button OpenInstallerButton { get; }

...
public static class GtpEngineExecutableGuard
{
    ...
    private static bool HasGuiFileName(string path)
    {
        ...
        return fileName.Contains("KifuwarabeGo2026.Gui", StringComparison.OrdinalIgnoreCase) ||
    ...
    private static bool ContainsGuiAssemblyArgument(string arguments) =>
        arguments.Contains("KifuwarabeGo2026.Gui.dll", StringComparison.OrdinalIgnoreCase) ||
        arguments.Contains("KifuwarabeGo2026.Gui.exe", StringComparison.OrdinalIgnoreCase);
}

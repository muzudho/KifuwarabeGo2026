...
public sealed partial class GoScreenRenderer
{
    ...
    private static Rectangle TextAreaCancelButtonBounds => new(1120, 810, 170, 58);
    private static Rectangle TextAreaApplyButtonBounds => new(1320, 810, 170, 58);

    public static bool GetTextAreaDialogCancelButtonHit(Point point) => TextAreaCancelButtonBounds.Contains(point);
        ...
        bool showCompositionDiagnostics = false)
    {
        ...
        {
            DrawCompositionLamp(TextAreaDialogBounds, "SDL", TextAreaDialogBounds.Right - 120, compositionDiagnostics.IsSdlWindowResolved, new Color(99, 223, 185));
            DrawCompositionLamp(TextAreaDialogBounds, "HOOK", TextAreaDialogBounds.Right - 76, compositionDiagnostics.IsWindowProcedureAttached, new Color(99, 223, 185));
            DrawCompositionLamp(TextAreaDialogBounds, "IME", TextAreaDialogBounds.Right - 30, composition.IsActive, new Color(255, 225, 128));
        }
        ...
        DrawFittedText("ENTER: NEW LINE   CTRL+ENTER: APPLY   ESC: CANCEL", new Rectangle(TextAreaDialogBounds.X + 70, 786, 800, 28), new Color(147, 201, 190), 0.29f);
        DrawCommandButton(TextAreaCancelButtonBounds, "CANCEL", false, mousePoint, scale: 0.38f);

...
dotnet run --project .\KifuwarabeGo2026.Gui.PortabilitySmoke\KifuwarabeGo2026.Gui.PortabilitySmoke.csproj --no-build
結果: PASS

dotnet run --project .\KifuwarabeGo2026.Gui.WindowsSmoke\KifuwarabeGo2026.Gui.WindowsSmoke.csproj --no-build
結果: PASS
```

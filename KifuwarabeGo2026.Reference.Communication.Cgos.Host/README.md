...
```powershell
dotnet run --project KifuwarabeGo2026.Reference.Communication.Cgos.Host -- --account black --engine-command ".\KifuwarabeGo2026.Reference.Communication.Gtp.Host\bin\Release\net8.0\win-x64\publish\KifuwarabeGo2026.Engine.exe"
```

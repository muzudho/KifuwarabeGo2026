...
public sealed record GtpEngineGuiOptionSpec(string Id, string Label, string Type, string DefaultValue, int? Min = null,
    int? Max = null, IReadOnlyList<string>? Values = null, string Binding = "",
...
public static class GtpEngineGuiOptions
{
    ...
    public const string AvoidEyesId = "AvoidEyes", RandomSeedId = "RandomSeed", RandomMoveId = "RandomMove";
    public const string EngineTagId = "EngineTag", DebugLogFileId = "DebugLogFile", ClearCacheId = "ClearCache";
    public const string BoardSizeId = "BoardSize", InitialMoveCountId = "InitialMoveCount";
    public const string GtpBoardSizeBinding = "gtp.boardsize", NormalRandomMove = "Normal";
    ...
    [
        new(AvoidEyesId, "AvoidEyes", "check", "true"), new(RandomSeedId, "RandomSeed", "spin", "", 0, int.MaxValue),
        new(RandomMoveId, "RandomMove", "combo", ChebyshevDistanceFromStarRandomMove, Values: RandomMoveValues),
        new(EngineTagId, "EngineTag", "string", ""), new(DebugLogFileId, "DebugLogFile", "filename", ""),
        new(ClearCacheId, "ClearCache", "button", "false"),
    ];
    public static readonly GtpEngineGuiOptionSpec[] PonnukiProviderSpecs =
    [
        new(BoardSizeId, "BoardSize", "combo", "9", Values: ["9"], Binding: GtpBoardSizeBinding, Choices: [new("9")]),

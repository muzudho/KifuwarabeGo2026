...
internal sealed class PackageInstaller(InstallerPaths paths, HttpClient client, InstallerLog log)
{
    ...
    internal static void Validate(InstallerProduct product, string expectedVersion, string directory)
    {
        ...
        if (product == InstallerProduct.Gui)
        {

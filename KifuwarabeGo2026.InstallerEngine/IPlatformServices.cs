...
public interface IInstallerPathProvider
{
...
public interface IInstallerEnginePlatform : IInstallerPathProvider, IRunningProcessCatalog, IPlatformProcessService
{
}

public interface IInstallerGuiPlatform
{
    string CreateLobbyShortcut() => "Desktop shortcut creation is not supported on this platform.";
